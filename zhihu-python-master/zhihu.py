...
class Post:
    ...
    def parser(self):
        r = requests.get('https://zhuanlan.zhihu.com/api/posts/' + self.slug , verify=False)
        self.meta = r.json()
...
class Column:
    ...
    def parser(self):
        r = requests.get('https://zhuanlan.zhihu.com/api/columns/' + self.slug, verify=False)
        self.meta = r.json()
...
class User:
    ...
    def parser(self):
        r = requests.get(self.user_url, verify=False)
    ...
    def get_followees(self):
        if self.user_url == None:
            ...
            if followees_num == 0:
                ...
                r = requests.get(followee_url, verify=False)
    ...
    def get_followers(self):
        if self.user_url == None:
            ...
            if followers_num == 0:
                ...
                r = requests.get(follower_url, verify=False)
        ...
        if self.user_url == None:
            ...
            if asks_num == 0:
                ...
                for i in xrange((asks_num - 1) / 20 + 1):
                    ...
                    r = requests.get(ask_url, verify=False)
        ...
        if self.user_url == None:
            ...
            if answers_num == 0:
                ...
                for i in xrange((answers_num - 1) / 20 + 1):
                    ...
                    r = requests.get(answer_url, verify=False)
                    soup = BeautifulSoup(r.content, "lxml")
        ...
        if self.user_url == None:
            ...
            if collections_num == 0:
                ...
                for i in xrange((collections_num - 1) / 20 + 1):
                    ...
                    r = requests.get(collection_url, verify=False)
...
class Answer:
    ...
    def parser(self):
        r = requests.get(self.answer_url, verify=False)
        soup = BeautifulSoup(r.content, "lxml")
        self.soup = soup
    ...
    def get_voters(self):
        ...
        r = requests.get(request_url, params={"params": "{\"answer_id\":\"%d\"}" % int(data_aid)}, verify=False)
        soup = BeautifulSoup(r.content, "lxml")
...
class Collection:
    ...
    def get_all_answers(self):
        ...
        if len(answer_list) == 0:
            ...
            i = 2
            while True:
                r = requests.get(self.url + "?page=" + str(i), verify=False)
